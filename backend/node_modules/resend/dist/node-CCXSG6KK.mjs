...
// node_modules/.pnpm/@react-email+render@1.0.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@react-email/render/dist/node/index.mjs
...
var pretty = (str, options = {}) => {
  return import_js_beautify.default.html(str, __spreadValues2(__spreadValues2({}, defaults), options));
};
...
var render2 = (element, options) => __async(void 0, null, function* () {
  ...
  const { default: reactDOMServer } = yield import("./server.node-UI4W6O6F.mjs");
  let html;
  ...
  if (options == null ? void 0 : options.plainText) {
    return convert(html, __spreadValues2({
